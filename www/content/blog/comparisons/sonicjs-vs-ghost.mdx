...
You already have it. The auto-generated [REST API](/api) gives you `GET /api/content/posts`, `GET /api/content/posts/:slug`, filtering, pagination, and field selection — same patterns as Ghost's Content API. Plug it into Astro, Next.js, or whatever you prefer.
...
pnpm dlx create-sonicjs-app my-cms
cd my-cms
npm run dev
