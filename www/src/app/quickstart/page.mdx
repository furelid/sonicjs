...
<CodeGroup title="One-Command Setup">
...
SonicJS is open source and we welcome contributions! Whether you're fixing bugs, improving documentation, or building new features, your help makes SonicJS better for everyone.

<div className="not-prose mt-6">
  <Button href="/contributing" variant="primary">
    <>Start Contributing</>
  </Button>
</div>

<div className="not-prose mt-4">
  <Button href="https://github.com/lane711/sonicjs" variant="text" arrow="right">
    <>View on GitHub</>
  </Button>
</div>
