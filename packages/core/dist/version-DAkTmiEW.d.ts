 ...
 */
type FilterOperator = 'equals' | 'not_equals' | 'greater_than' | 'greater_than_equal' | 'less_than' | 'less_than_equal' | 'like' | 'contains' | 'starts_with' | 'ends_with' | 'in' | 'not_in' | 'all' | 'exists' | 'near' | 'within' | 'intersects';
...
declare class MetricsTracker {
    ...
    private readonly totalBuckets;
    private readonly oneSecondBuckets;
...
export { type FilterCondition as F, type QueryFilter as Q, SONICJS_VERSION as S, TemplateRenderer as T, type FilterGroup as a, type FilterOperator as b, QueryFilterBuilder as c, type QueryResult as d, buildQuery as e, escapeHtml as f, getCoreVersion as g, sanitizeObject as h, metricsTracker as m, renderTemplate as r, sanitizeInput as s, templateRenderer as t };
