...
// Deploy with: pnpm dlx wrangler deploy
```
...
| Admin brute-force | Common attack target | JWT + KV-cached verification, [rate-limited auth](/authentication) |
...
You also get the auto-generated `GET /api/content/posts` endpoint for free without writing any code. See the [API reference](/api).
